...
# from huggingface_hub import hugginface_cli
# huggingface-cli login

# for comand prompt usage Adding HuggingFace argument
# parser.add_argument(
#     "--repo-id",
#     type=str,
#     default="asFrants/PPO-CartPole-v1",
#     help="id of the model repository from the Hugging Face Hub {username/repo_name}",
# )

# package_to_hub(
#     repo_id=args.repo_id,                         # "asFrants/PPO-CartPole-v1"
#     model=agent,                                  # The model we want to save
#     hyperparameters=args,
#     eval_env=gym.make(args.env_id),               # CartPole-v1
